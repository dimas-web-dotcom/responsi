...
// Ambil data petugas dan keberangkatan untuk dropdown
$sql_petugas = "SELECT id_petugas, nama FROM petugas";
$result_petugas = $conn->query($sql_petugas);

$sql_keberangkatan = "SELECT id_keberangkatan FROM keberangkatan";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Menggunakan stored procedure untuk menambah petugas keberangkatan
    $sql = "CALL tambah_petugas_keberangkatan('$id_petugas', '$tugas', '$id_keberangkatan')";
...
<head>
    ...
    <title>Tambah Petugas Keberangkatan</title>
    <style>
...
<body>
    ...
    <div class="form-container">
        <h2>Tambah Petugas Keberangkatan</h2>
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="id_keberangkatan" name="id_keberangkatan" required>
                    ...
                    <?php while ($row = $result_keberangkatan->fetch_assoc()): ?>
                        <option value="<?= $row['id_keberangkatan'] ?>"><?= $row['id_keberangkatan'] ?></option>
                    <?php endwhile; ?>
                </select>
            </div>
