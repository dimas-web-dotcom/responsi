...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Menggunakan stored procedure untuk menambah rute
    $sql = "CALL tambah_rute('$kota_asal', '$kota_tujuan', '$jarak_km', '$estimasi_waktu', '$harga_tiket')";
    ...
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="jarak_km" name="jarak_km" required>
            </div>
            
            <div class="form-group">
                <label for="estimasi_waktu">Estimasi Waktu:</label>
                <input type="text" id="estimasi_waktu" name="estimasi_waktu" required>
            </div>
